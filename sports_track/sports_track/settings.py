"""
Django settings for sports_track project.
...
SECRET_KEY = 'django-insecure-qn0uks*!o!wrt@06d^%8&-k8%h%=_$$6i@silw$gzcs*lzfg$f'
...
ROOT_URLCONF = 'sports_track.urls'
...
WSGI_APPLICATION = 'sports_track.wsgi.application'
